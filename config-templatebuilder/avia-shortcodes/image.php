...
if ( !class_exists( 'avia_sc_image' ) ) 
{
	class avia_sc_image extends aviaShortcodeTemplate
	{
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				$output = "";
				$class  = "";
				extract(shortcode_atts(array('src'=>'', 'animation'=>'no-animation', 'link'=>''), $atts));
				...
				{	
					...
					else
					{
						...
						{
							$output.= "<img class='avia_image ".$meta['el_class'].$this->class_by_arguments('align' ,$atts, true)." {$class}' src='{$src}' alt=''  />";
						}
					}
