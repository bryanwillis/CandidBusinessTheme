...
if ( !class_exists( 'avia_sc_sidebar' ) ) 
{
	class avia_sc_sidebar extends aviaShortcodeTemplate
	{
			/**
			...
			{
				$this->config['name']		= __('Sidebar', 'avia_framework' );
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				if( is_dynamic_sidebar( $atts['widget_area'] ) )
				{
					...
					$output = ShortcodeHelper::avia_remove_autop(ob_get_clean());
